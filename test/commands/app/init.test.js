...
describe('--login', () => {
  ...
  test('--yes with no existing projects uses App1', async () => {
    ...
    expect(mockConsoleCLIInstance.createProject).toHaveBeenCalledWith(
      expect.anything(),
      { name: 'App1', title: 'AB Project 1', description: 'App Builder Project 1 - generated by an agent' }
    )
    expect(importHelperLib.importConfigJson).toHaveBeenCalled()
  })
  ...
  test('--yes skips existing names and picks next available suffix', async () => {
    ...
    expect(mockConsoleCLIInstance.createProject).toHaveBeenCalledWith(
      expect.anything(),
      { name: 'App4', title: 'AB Project 4', description: 'App Builder Project 4 - generated by an agent' }
    )
  })
  ...
  test('--yes skips non-sequential gaps and picks first available', async () => {
    ...
    expect(mockConsoleCLIInstance.createProject).toHaveBeenCalledWith(
      expect.anything(),
      { name: 'App2', title: 'AB Project 2', description: 'App Builder Project 2 - generated by an agent' }
    )
  })
