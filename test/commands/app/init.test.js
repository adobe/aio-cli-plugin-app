...
describe('--login', () => {
  ...
  test('--yes with no existing projects uses generatedApp1', async () => {
    mockConsoleCLIInstance.getProjects.mockResolvedValue([])
    mockConsoleCLIInstance.createProject.mockResolvedValue({ id: 'newprojid', name: 'generatedApp1' })
    ...
    expect(mockConsoleCLIInstance.createProject).toHaveBeenCalledWith(
      expect.anything(),
      { name: 'generatedApp1', title: 'AB Project 1', description: 'App Builder Project 1 - generated by an agent' }
    )
    expect(importHelperLib.importConfigJson).toHaveBeenCalled()
  })
  ...
  test('--yes skips existing names and picks next available suffix', async () => {
    ...
    mockConsoleCLIInstance.createProject.mockResolvedValue({ id: 'newprojid', name: 'generatedApp4' })
    ...
    expect(mockConsoleCLIInstance.createProject).toHaveBeenCalledWith(
      expect.anything(),
      { name: 'generatedApp4', title: 'AB Project 4', description: 'App Builder Project 4 - generated by an agent' }
    )
  })
  ...
  test('--yes skips non-sequential gaps and picks first available', async () => {
    ...
    mockConsoleCLIInstance.createProject.mockResolvedValue({ id: 'newprojid', name: 'generatedApp2' })
    ...
    expect(mockConsoleCLIInstance.createProject).toHaveBeenCalledWith(
      expect.anything(),
      { name: 'generatedApp2', title: 'AB Project 2', description: 'App Builder Project 2 - generated by an agent' }
    )
  })
