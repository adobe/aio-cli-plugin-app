...
describe('parseNamespaceString', () => {
  test('should parse development namespace correctly', () => {
    const namespace = 'development-12345-myapp-dev'
    const result = appHelper.parseNamespaceString(namespace)
    expect(result).toEqual({
      development: true,
      orgId: '12345',
      appName: 'myapp',
  ...
  test('should parse production namespace correctly', () => {
    const namespace = '12345-myapp-prod'
    const result = appHelper.parseNamespaceString(namespace)
    expect(result).toEqual({
      development: false,
      orgId: '12345',
  ...
  test('should parse namespace without workspace correctly', () => {
    const namespace = '12345-myapp'
    const result = appHelper.parseNamespaceString(namespace)
    expect(result).toEqual({
      development: false,
      orgId: '12345',
  ...
  test('should handle case insensitive namespace', () => {
    const namespace = 'DEVELOPMENT-12345-MYAPP-DEV'
    const result = appHelper.parseNamespaceString(namespace)
    expect(result).toEqual({
      development: true,
  ...
  test('should return null for invalid namespace format', () => {
