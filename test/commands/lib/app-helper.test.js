...
describe('sort tests', () => {
  ...
  test('sort defaults (ascending, date)', () => {
    ...
    appHelper.sortValues(toSort, { descending: false })
  ...
  test('sort (descending, name)', () => {
    ...
    appHelper.sortValues(toSort, { field: 'name' })
  ...
  test('sort with duplicate entry, for coverage (ascending, name)', () => {
    ...
    appHelper.sortValues(toSort, { descending: false, field: 'name' })
  ...
  test('sort (unknown field)', () => {
    ...
    appHelper.sortValues(toSort, { field: 'unknown-field' })
...
test('prompt', async () => {
  ...
  await expect(appHelper.prompt()).resolves.toEqual(true)
})
